const data = {
  ...
  categories: [
    {
      name: 'mammals',
      image: '/img/cat/categories/mammals.png',
    },
    {
      name: 'mammalsbabies',
      image: '/img/cat/categories/mammalsbabies.png',
    },
    {
      name: 'birds',
    ...
    {
      name: 'insects',
      image: '/img/cat/categories/insect.png',
    },
    {
      name: 'mashrooms',
      image: '/img/cat/categories/mashroom.png',
    },
    {
      name: 'amphibians',
      image: '/img/cat/categories/amphibian.png',
    },
    {
      name: 'reptiles',
      image: '/img/cat/categories/reptile.png',
    },
  ],
  images: [
    { cat: 'mammals', name: 'alnis', image: '/img/cat/mammals/alnis.png' },    
    { cat: 'mammals', name: 'apsis', image: '/img/cat/mammals/apsis.png' },
    { cat: 'mammals', name: 'caune', image: '/img/cat/mammals/caune.png' },    
    { cat: 'mammals', name: 'ezis', image: '/img/cat/mammals/ezis.png' },
    { cat: 'mammals', name: 'lacis', image: '/img/cat/mammals/lacis.png' },
    { cat: 'mammals', name: 'lapsina', image: '/img/cat/mammals/lapsina.png' },
    { cat: 'mammals', name: 'lusis', image: '/img/cat/mammals/lusis.png' },
    { cat: 'mammals', name: 'pele', image: '/img/cat/mammals/pele.png' },
    { cat: 'mammals', name: 'stirna', image: '/img/cat/mammals/stirna.png' },
    { cat: 'mammals', name: 'vavere', image: '/img/cat/mammals/vavere.png' },
    { cat: 'mammals', name: 'vilks', image: '/img/cat/mammals/vilks.png' },
    { cat: 'mammals', name: 'zakis', image: '/img/cat/mammals/zakis.png' },
    { cat: 'mammalsbabies', name: 'alnens', image: '/img/cat/mammalsbabies/alnens.png' },
    { cat: 'mammalsbabies', name: 'apsens', image: '/img/cat/mammalsbabies/apsens.png' },
    { cat: 'mammalsbabies', name: 'caunens', image: '/img/cat/mammalsbabies/caunens.png' },
    { cat: 'mammalsbabies', name: 'ezens', image: '/img/cat/mammalsbabies/ezens.png' },
    { cat: 'mammalsbabies', name: 'lacens', image: '/img/cat/mammalsbabies/lacens.png' },
    { cat: 'mammalsbabies', name: 'lapsens', image: '/img/cat/mammalsbabies/lapsens.png' },
    { cat: 'mammalsbabies', name: 'lusens', image: '/img/cat/mammalsbabies/lusens.png' },
    { cat: 'mammalsbabies', name: 'pelens', image: '/img/cat/mammalsbabies/pelens.png' },
    { cat: 'mammalsbabies', name: 'stirnens', image: '/img/cat/mammalsbabies/stirnens.png' },
    { cat: 'mammalsbabies', name: 'vilcens', image: '/img/cat/mammalsbabies/vilcens.png' },
    { cat: 'mammalsbabies', name: 'zakens', image: '/img/cat/mammalsbabies/zakens.png' },
